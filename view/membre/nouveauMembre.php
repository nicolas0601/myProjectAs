...
<div class="wrapper">
    <form class="form-horizontal" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="nom" id="firstName" placeholder="Nom Comple" class="form-control" autofocus>
<!--                <span class="help-block">Last Name, First Name, eg.: Smith, Harry</span>-->
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="email" name="email" id="mail" placeholder="mail" class="form-control">
            </div>
        </div>
        <div class="form-group">
            <label for="password" class="col-sm-3 control-label">Mot de Passe</label>
            <div class="col-sm-9">
                <input type="password" name="pwd" id="password" placeholder="Mot De Passe" class="form-control">
            </div>
        </div>
        <div class="form-group">
